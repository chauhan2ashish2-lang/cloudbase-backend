        ...
        <>
          ...
          {businesses.length > 0 && (
            <div className="grid gap-4 mb-6">
              {businesses.map((b) => (
                <Link href={`/dashboard/business/${b.id}`} key={b.id} className="border border-neutral-800 rounded-xl p-5 flex items-center justify-between hover:border-neutral-600 transition">
                  <div>
